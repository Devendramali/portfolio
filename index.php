            ...
            <div class="row align-items-center">
               <div class="col-md-6">
                  <div class="hero-content-box">
                     ...
                     <div class="button-box d-flex flex-wrap align-items-center">
                        <a href="#" class="btn tj-btn-secondary">Download CV <i class="fa-solid fa-download"></i></a>
                        <ul class="ul-reset social-icons">
                           <li>
                              <a href="https://www.instagram.com/devendra241201"><i class="fa-brands fa-instagram"></i></a>
                           </li>
                           <li>
                              <a href="https://github.com/devendramali"><i class="fa-brands fa-github"></i></a>
                           </li>
                           <li>
                              <a href="https://in.linkedin.com/in/devendra-mali-b130b2254"><i class="fa-brands fa-linkedin-in"></i></a>
                           </li>
               ...
               <div class="col-md-6 d-none d-md-block">
                  <div class="hero-image-box text-center">
                     <img src="assets/img/hero/me1.png" height="475px" alt="" />
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12">
                  ...
                  <div class="portfolio-box wow fadeInUp" data-wow-delay=".6s">
                     ...
                     <div class="portfolio-item branding">
                        ...
                        <a href="https://www.futurebackedsolutions.com/" class="content-box">
                           <h3 class="portfolio-title">Future Backed</h3>
                           <p>learning here extends beyond classrooms with opportunities to work on real-world projects.</p>
                           <i class="fa-solid fa-arrow-up-long"></i>
                     ...
                     <div class="portfolio-item uxui">
                        ...
                        <a href="https://www.digihost.in/website-development-company-in-mumbai" class="content-box">
                           <h3 class="portfolio-title">Diigiihost</h3>
                           <p>Landing page for Diigiihost tech Solution</p>
                           <i class="fa-solid fa-arrow-up-long"></i>
                           <!-- <button data-mfp-src="#portfolio-wrapper" class="portfolio-link modal-popup"></button> -->
                        </a>
                     </div>
                     <div class="portfolio-item mobile-app">
                        ...
                        <a href="https://shelterorealtech.com" class="content-box">
                           <h3 class="portfolio-title">Sheltero</h3>
                           <p>Sheltero Realtech is a tech-driven platform that enables collaboration between Real Estate Developers and Channel partners (brokers)</p>
                           <i class="fa-solid fa-arrow-up-long"></i>
                           <!-- <button data-mfp-src="#portfolio-wrapper" class="portfolio-link modal-popup"></button> -->
                        </a>
                     </div>
                     <div class="portfolio-item branding">
                        ...
                        <a href="https://www.vedicip.com/" class="content-box">
                           <h3 class="portfolio-title">Vedic IP</h3>
                           <p>Vedic IP have emerged as the most trusted law firm, catering especially in the field of IP protection, enforcement, and prosecution to corporate & commercial firms.</p>
                           <i class="fa-solid fa-arrow-up-long"></i>
                           <!-- <button data-mfp-src="#portfolio-wrapper" class="portfolio-link modal-popup"></button> -->
                        </a>
                     </div>
            ...
            <div class="row">
               <div class="col-md-6">
                  <div class="section-header wow fadeInUp" data-wow-delay=".3s">
                     <h2 class="section-title"><i class="fa-solid fa-award "></i> My Experience</h2>
                  </div>
                  ...
                  <div class="resume-widget">
                     <div class="resume-item wow fadeInLeft" data-wow-delay=".4s">
                        ...
                        <div class="institute">Digihost Tech Solutions Pvt. Ltd. Mumbai</div>
                     </div>
               ...
               <div class="col-md-6">
                  ...
                  <div class="resume-widget">
                     <div class="resume-item wow fadeInRight" data-wow-delay=".5s">
                        ...
                        <h3 class="resume-title">Full Stack Developer(MERN)</h3>
                        <div class="institute">Infinite Graphix Technologies, Pune</div>
                     </div>
                     <div class="resume-item wow fadeInRight" data-wow-delay=".5s">
                        <div class="time">2019 - 2022</div>
                        <h3 class="resume-title">BSc Computer Science</h3>
                        <div class="institute">G.T. Patil Collage Nandurbar</div>
                     </div>
                     <div class="resume-item wow fadeInRight" data-wow-delay=".6s">
                        <div class="time">2018 - 2019</div>
                        <h3 class="resume-title">H.S.C</h3>
                        <div class="institute">G.T. Patil Collage Nandurbar</div>
                     </div>
                     <div class="resume-item wow fadeInRight" data-wow-delay=".7s">
                        <div class="time">2016 - 2017</div>
                        <h3 class="resume-title">S.S.C</h3>
                        <div class="institute">K. P. Patil Madhyamik Vidyalay Bhaler </div>
                     </div>
                  ...
                  <div class="skills-widget d-flex flex-wrap justify-content-center align-items-center">
                     <div class="skill-item wow fadeInUp" data-wow-delay=".3s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="assets/img/skill/html.webp" alt="" />
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".4s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="assets/img/skill/css.webp" alt="" />
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".5s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="assets/img/skill/js.svg" alt="" />
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".7s">
                        <div class="skill-inner">
                           <div class="icon-box">
                              <img src="assets/img/skill/nodejs.png" alt="" />
                           </div>
                     ...
                     <div class="skill-item wow fadeInUp" data-wow-delay=".8s">
                        <div class="skill-inner">
                           <div class="icon-box d-flex justify-content-center align-content-center flex-wrap">
                              <img class="h-auto d-block" src="assets/img/skill/express.webp" alt="" />
                           </div>
               ...
               <div class="col-lg-4 col-md-6">
                  <div class="blog-item wow fadeInUp" data-wow-delay=".5s">
                     ...
                     <div class="blog-content">
                        ...
                        <h3 class="blog-title"><a href="blog-details.php">top 10 ui ux designers</a></h3>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="blog-item wow fadeInUp" data-wow-delay=".6s">
                     ...
                     <div class="blog-content">
                        ...
                        <h3 class="blog-title"><a href="blog-details.php">App Development Guides</a></h3>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="blog-item wow fadeInUp" data-wow-delay=".7s">
                     ...
                     <div class="blog-content">
                        ...
                        <h3 class="blog-title"><a href="blog-details.php">learn graphic design free</a></h3>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-lg-6 col-md-7 order-2 order-md-1">
                  <div class="contact-form-box wow fadeInLeft" data-wow-delay=".3s">
                     ...
                     <div class="tj-contact-form" id="form-container">
                     <form id="contact-form" onsubmit="sendEmail(); return false; reset()">
                        <div class="row gx-3">
                           <div class="col-sm-6">
                                 <div class="form_group">
                  ...
                  <div class="contact-info-list">
                     <ul class="ul-reset">
                        <li class="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                           ...
                           <div class="text-box">
                              <p>Phone</p>
                              <a href="tel:8698396653">+91 8698396653</a>
                           </div>
                        </li>
                        <li class="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                           data-wow-delay=".5s">
                        ...
                        <li class="d-flex flex-wrap align-items-center position-relative wow fadeInRight"
                           ...
                           <div class="text-box">
                              <p>Address</p>
                              <a href="#">At. Kakarde <br>Tal dist Nandurbar 425412 </a>
                           </div>
                        </li>
                     </ul>
                  </div>
